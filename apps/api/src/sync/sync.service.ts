...
export class SyncService {
    ...
    async pull(entityName: string, organizationId: string, lastCheckpoint: any, limit: number) {
    ...
    private getRepository(entityName: string): Repository<any> {
        switch (entityName) {
            case 'orders': return this.ordersRepository;
            case 'products': return this.productsRepository;
