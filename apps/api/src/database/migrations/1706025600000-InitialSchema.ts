...
export class InitialSchema1706025600000 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.createIndex(
            'products',
            new TableIndex({ name: 'IDX_products_organization_id', columnNames: ['organization_id'] }),
        );
        await queryRunner.createIndex(
            'products',
        ...
        await queryRunner.createIndex(
            'products',
            new TableIndex({ name: 'IDX_products_barcode', columnNames: ['barcode'] }),
        );
        await queryRunner.createIndex(
            'orders',
            new TableIndex({ name: 'IDX_orders_organization_id', columnNames: ['organization_id'] }),
        );
        await queryRunner.createIndex(
            'orders',
